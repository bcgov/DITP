...
| **Examples** | <pre><code>{ "schema_version": "1.0", "services": [ { "service_id": "STR-001", "service_short_name": "Short-Term Rental", "auth_expiry_date": "2026-12-31", "service_options": [ { "name": "document_types", "value": "Development Permits, Building Permits", "type": "string_list", "mandatory": true } ] }, { "service_id": "RPP-002", "service_short_name": "Residential Parking Permit", "auth_expiry_date": "2027-06-30", "service_options": [] } ] }</code></pre> |
